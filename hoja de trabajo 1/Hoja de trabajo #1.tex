...
\end{flushleft}
\end{LARGE}
\section*{2) Conjunto de vértices}
\begin{LARGE}
\begin{flushleft}
(1,1)=  (1,2)(1,3)(1,4)(1,5)\\
(2,2)=  (2,1)(2,3)(2,4)(2,6)\\
...
\begin{Large}
\begin{itemize}
 \item ¿Que estructura de datos podría representar un lanzamiento de dados?
 \begin{itemize}
 \item El lanzamiento de los dados es una secuencia que forma vértices entre el estado anterior y el estado actual que cumplen con las propiedad regida por la rotación del dado la cual es solo puede girar a un lado adyacente.
 \end{itemize}
...
4)El dado que se movió muestra un numero aleatorio entre los números posibles gracias al giro de noventa grados.\\
5)El segundo dado repite el paso 3 y 4.\\
6)Ambos dados darán un resultado.\\
7)Fin\\
...
\item No es necesario hacer la rotación de dados ya que siempre habrá un resultado.
...
\end{enumerate}
Si se cumple todo lo mencionado anteriormente se obtendrá una pareja de números que representan la combinación de resultados de ambos dado.
\end{flushleft}
\end{itemize}
